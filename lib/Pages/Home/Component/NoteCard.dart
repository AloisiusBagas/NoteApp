  ...
  Widget build(BuildContext context) {
    ...
    return FocusedMenuHolder(
      ...
      menuItems: <FocusedMenuItem>[
        FocusedMenuItem(
          title: const Text("Open", style: TextStyle(color: Colors.black)),
          trailingIcon: Icon(Icons.open_in_new, color: Colors.grey[400]),
          onPressed: () {
        ...
        FocusedMenuItem(
          ...
          trailingIcon: Icon(Icons.info, color: Colors.grey[400]),
          onPressed: () {
            infoalert(context, _themechanger, note.createdat, note.updateat);
          },
        ),
        FocusedMenuItem(
          title: Text(
          ...
          trailingIcon: Icon(Icons.archive_rounded, color: Colors.grey[400]),
          onPressed: () {
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      if (note.title.isNotEmpty && note.note.isNotEmpty == true)
